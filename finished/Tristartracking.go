...
Chinmay Sahoo - Initial Contribution
MAY 2017
******************************************************************************/
//SN: May 2017

// IoT Blockchain Ttracking and monitoring Smart Contract v 1.0
...
func (t *SimpleChaincode) readAssetSchemas(stub shim.ChaincodeStubIntrface, args []string) ([]byte, error) {
